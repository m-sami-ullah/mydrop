...
class PagePolicy
{
    ...
    {
        $permission = Permission::key('page','view',$user->group_user->pluck('id'))->get();;
     ...
     *
     * @param  \App\User  $user
     * @param  \App\Models\Model=Group  $model=Page
     * @return mixed
     */
    ...
    {
        $permission = Permission::key('page','add',$user->group_user->pluck('id'))->get();;
        return $permission->count() ? true:false;
    }
    ...
    {
        $permission = Permission::key('page','update',$user->group_user->pluck('id'))->get();;
        return $permission->count() ? true:false;
    }
    ...
    {
        $permission = Permission::key('page','delete',$user->group_user->pluck('id'))->get();;
        return $permission->count() ? true:false;
    }
