...
class TestimonialPolicy
{
    ...
    {
        $permission = Permission::key('testimonial','view',$user->group_user->pluck('id'))->get();;
     ...
     *
     * @param  \App\User  $user
     * @param  \App\Models\Model=Group  $model=Testimonial
     * @return mixed
     */
    ...
    {
        $permission = Permission::key('testimonial','add',$user->group_user->pluck('id'))->get();;
        return $permission->count() ? true:false;
    }
    ...
    {
        $permission = Permission::key('testimonial','update',$user->group_user->pluck('id'))->get();;
        return $permission->count() ? true:false;
    }
    ...
    {
        $permission = Permission::key('testimonial','delete',$user->group_user->pluck('id'))->get();;
        return $permission->count() ? true:false;
    }
