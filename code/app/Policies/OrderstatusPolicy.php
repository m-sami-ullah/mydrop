...
class OrderstatusPolicy
{
    ...
    {
        $permission = Permission::key('orderstatus','view',$user->group_user->pluck('id'))->get();;
     ...
     *
     * @param  \App\User  $user
     * @param  \App\Models\Model=Group  $model=Orderstatus
     * @return mixed
     */
    ...
    {
        $permission = Permission::key('orderstatus','add',$user->group_user->pluck('id'))->get();;
        return $permission->count() ? true:false;
    }
    ...
    {
        $permission = Permission::key('orderstatus','update',$user->group_user->pluck('id'))->get();;
        return $permission->count() ? true:false;
    }
    ...
    {
        $permission = Permission::key('orderstatus','delete',$user->group_user->pluck('id'))->get();;
        return $permission->count() ? true:false;
    }
