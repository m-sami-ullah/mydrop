...
class FeaturePolicy
{
    ...
    {
        $permission = Permission::key('feature','view',$user->group_user->pluck('id'))->get();;
     ...
     *
     * @param  \App\User  $user
     * @param  \App\Models\Model=Group  $model=Feature
     * @return mixed
     */
    ...
    {
        $permission = Permission::key('feature','add',$user->group_user->pluck('id'))->get();;
        return $permission->count() ? true:false;
    }
    ...
    {
        $permission = Permission::key('feature','update',$user->group_user->pluck('id'))->get();;
        return $permission->count() ? true:false;
    }
    ...
    {
        $permission = Permission::key('feature','delete',$user->group_user->pluck('id'))->get();;
        return $permission->count() ? true:false;
    }
