...
class ServicePolicy
{
    ...
    {
        $permission = Permission::key('service','view',$user->group_user->pluck('id'))->get();;
     ...
     *
     * @param  \App\User  $user
     * @param  \App\Models\Model=Group  $model=Service
     * @return mixed
     */
    ...
    {
        $permission = Permission::key('service','add',$user->group_user->pluck('id'))->get();;
        return $permission->count() ? true:false;
    }
    ...
    {
        $permission = Permission::key('service','update',$user->group_user->pluck('id'))->get();;
        return $permission->count() ? true:false;
    }
    ...
    {
        $permission = Permission::key('service','delete',$user->group_user->pluck('id'))->get();;
        return $permission->count() ? true:false;
    }
