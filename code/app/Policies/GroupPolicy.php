...
class GroupPolicy
{
    ...
    {
        $permission = Permission::key('group','view',$user->group_user->pluck('id'))->get();;
    ...
    {
        $permission = Permission::key('group','add',$user->group_user->pluck('id'))->get();;
        return $permission->count() ? true:false;
    }
    ...
    {
        $permission = Permission::key('group','update',$user->group_user->pluck('id'))->get();;
        return $permission->count() ? true:false;
    }
    ...
    {
        $permission = Permission::key('group','delete',$user->group_user->pluck('id'))->get();;
        return $permission->count() ? true:false;
    }
