...
class PermissionPolicy
{
    ...
    {
        $permission = Permission::key('permission','view',$user->group_user->pluck('id'))->get();;
     ...
     *
     * @param  \App\User  $user
     * @param  \App\Models\Model=Group  $model=Permission
     * @return mixed
     */
    ...
    {
        $permission = Permission::key('permission','add',$user->group_user->pluck('id'))->get();;
        return $permission->count() ? true:false;
    }
    ...
    {
        $permission = Permission::key('permission','update',$user->group_user->pluck('id'))->get();;
        return $permission->count() ? true:false;
    }
    ...
    {
        $permission = Permission::key('permission','delete',$user->group_user->pluck('id'))->get();;
        return $permission->count() ? true:false;
    }
