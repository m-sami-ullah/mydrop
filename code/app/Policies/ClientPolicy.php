...
class ClientPolicy
{
    ...
    {
        $permission = Permission::key('client','view',$user->group_user->pluck('id'))->get();;
     ...
     *
     * @param  \App\User  $user
     * @param  \App\Models\Model=Group  $model=Client
     * @return mixed
     */
    ...
    {
        $permission = Permission::key('client','add',$user->group_user->pluck('id'))->get();;
        return $permission->count() ? true:false;
    }
    ...
    {
        $permission = Permission::key('client','update',$user->group_user->pluck('id'))->get();;
        return $permission->count() ? true:false;
    }
    ...
    {
        $permission = Permission::key('client','delete',$user->group_user->pluck('id'))->get();;
        return $permission->count() ? true:false;
    }
