...
class PackagePolicy
{
    ...
    {
        $permission = Permission::key('package','view',$user->group_user->pluck('id'))->get();;
     ...
     *
     * @param  \App\User  $user
     * @param  \App\Models\Model=Group  $model=Package
     * @return mixed
     */
    ...
    {
        $permission = Permission::key('package','add',$user->group_user->pluck('id'))->get();;
        return $permission->count() ? true:false;
    }
    ...
    {
        $permission = Permission::key('package','update',$user->group_user->pluck('id'))->get();;
        return $permission->count() ? true:false;
    }
    ...
    {
        $permission = Permission::key('package','delete',$user->group_user->pluck('id'))->get();;
        return $permission->count() ? true:false;
    }
