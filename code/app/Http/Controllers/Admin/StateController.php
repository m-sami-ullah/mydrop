...
use Exception;
use DB;
class StateController extends WebController
{
...
$this->countryservice = $countryservice;
    ...
    public function create(Request $request)
    {
        $this->authorize('create', State::class);
        		...
        		$countries = $this->countryservice->get($request);
		$countriesoptions = $this->countryservice->dropdown($countries,old('country_id'),['id','name']);

        return view('admin.states.create',['countryoptions' => $countriesoptions]);
    }
    ...
    public function edit(Request $request,State $state)
    {
        $this->authorize('update', $state);
        		...
        		$countries = $this->countryservice->get($request);
		$countriesoptions = $this->countryservice->dropdown($countries,$state->country_id,['id','name']);

        return view('admin.states.edit',['state' => $state,'countryoptions' => $countriesoptions]);
    }
