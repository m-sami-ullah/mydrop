...
<div class="form-group">
		    ...
		    <div class="col-lg-9 col-md-12 col-sm-12 {{ $errors->has('btntitle')?'has-error':'' }}">
		        <input   name="btntitle" value="{{ old('btntitle') }}"  class="form-control" id="btntitle" placeholder="Button Title" type="text">
...
<div class="form-group">
		    ...
		    <div class="col-lg-9 col-md-12 col-sm-12 {{ $errors->has('link')?'has-error':'' }}">
		        <input   name="link" value="{{ old('link') }}"  class="form-control" id="link" placeholder="Link" type="text">
		        		        @if($errors->has('link'))
