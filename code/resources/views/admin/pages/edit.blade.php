...
<form class="form-horizontal"   method="post" action="{{route('pages.update',['page'=>$page->id])}}" enctype="multipart/form-data">
...
<div class="col-md-12">
        <div class="panel">
		    ...
		    <div class="col-lg-10 col-md-12 col-sm-12 {{ $errors->has('name')?'has-error':'' }}">
		        <input   name="name" value="{{ old('name',$page->name) }}"  class="form-control" id="name" placeholder="Title" type="text">
		        		        @if($errors->has('name'))
	    ...
	    @endif
	        ...
	        <div class="form-group">
			    ...
			    <div class="col-lg-10 col-md-9 col-sm-12 {{ $errors->has('slug')?'has-error':'' }}">
			        <input   name="slug" value="{{ old('slug',$page->slug) }}"  class="form-control" id="slug" placeholder="Slug" type="text">
			        			        @if($errors->has('slug'))
		...
		<div class="form-group">
		    ...
		    <div class="col-lg-9 col-md-12 col-sm-12 {{ $errors->has('short_description')?'has-error':'' }}">
		        <textarea   name="short_description"  class="form-control" >{{ old('short_description',$page->short_description) }}</textarea>
				@if($errors->has('name'))
...
<div class="form-group">
		    ...
		    <div class="col-lg-10 col-sm-9 {{ $errors->has('description')?'has-error':'' }}">
		    	<textarea   name="description"   class="form-control summernote" id="description" >{{ old('description',$page->description) }}</textarea>
...
<div class="form-group">
		    ...
		    <div class="col-lg-9 col-md-12 col-sm-12 {{ $errors->has('image')?'has-error':'' }}">
		        <input   name="image" value="{{ old('image',$page->getimage()) }}"  class="form-control" id="image" placeholder="Banner" type="file">
		        		        @if($errors->has('image'))
	    	<p class="help-block">{{ $errors->first('image') }}</p> 
	    @endif
		    </div>
		    <div class="col-lg-9 col-md-12 col-sm-12">
	        	<img height="70" src="{{ old('image',$page->getimage()) }}">  
		    </div>
...
<div class="form-group">
		    ...
		    <div class="col-lg-9 col-md-12 col-sm-12 {{ $errors->has('status')?'has-error':'' }}">
		        <input   name="status" value="{{ old('status',$page->status) }}"    class="" id="status" placeholder="Status" type="checkbox">
...
<div class="form-group">
		    ...
		    <div class="col-lg-9 col-md-12 col-sm-12 {{ $errors->has('meta_title')?'has-error':'' }}">
		        <input   name="meta_title" value="{{ old('meta_title',$page->meta_title) }}"  class="form-control" id="meta_title" placeholder="Meta title" type="text">
...
<div class="form-group">
		    ...
		    <div class="col-lg-9 col-md-12 col-sm-12 {{ $errors->has('keywords')?'has-error':'' }}">
		        <input   name="keywords" value="{{ old('keywords',$page->keywords) }}"  class="form-control" id="keywords" placeholder="Keywords" type="text">
