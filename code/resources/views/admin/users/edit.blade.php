...
<form class="form-horizontal"   method="post" action="{{route('users.update',['user'=>$user->id])}}" enctype="multipart/form-data">
...
<div class="col-md-12">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 ">               
		    ...
		    <div class="col-lg-8 col-md-6 col-sm-12 {{ $errors->has('name')?'has-error':'' }}">
		        <input   name="name" value="{{ old('name',$user->name) }}"  class="form-control" id="name" placeholder="Full Name" type="text">
		        		        @if($errors->has('name'))
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 ">    
		<div class="form-group">
		    <label for="" class="col-lg-4 col-md-6 col-sm-12 control-label">Email Address *</label>
		    <div class="col-lg-8 col-md-6 col-sm-12 {{ $errors->has('email')?'has-error':'' }}">
		        <input   name="email" value="{{ old('email',$user->email) }}"  class="form-control" id="email" placeholder="Email Address" type="email">
		         		        @if($errors->has('email'))
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 ">    
		<div class="form-group">
		    <label for="" class="col-lg-4 col-md-6 col-sm-12 control-label">Password </label>
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 ">    
		<div class="form-group">
		    ...
		    <div class="col-lg-8 col-md-6 col-sm-12 {{ $errors->has('activated')?'has-error':'' }}">
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 ">    
		<div class="form-group">
		    <label for="" class="col-lg-4 col-md-6 col-sm-12 control-label">Group *</label>
		    <div class="col-lg-8 col-md-6 col-sm-12 {{ $errors->has('group_id[]')?'has-error':'' }}">
