    ...
    <div class="col-md-12">
		...
		<div class="form-group">
		    ...
		    <div class="col-lg-9 col-md-12 col-sm-12 {{ $errors->has('name')?'has-error':'' }}">
		        <input   name="name" value="{{ old('name') }}"  class="form-control" id="name" placeholder="Package Name" type="text">
		        		        @if($errors->has('name'))
...
<div class="form-group">
		    ...
		    <div class="col-lg-9 col-md-12 col-sm-12 {{ $errors->has('price')?'has-error':'' }}">
		        <input  step=&quot;.01&quot; name="price" value="{{ old('price') }}"  class="form-control" id="price" placeholder="Price" type="number">
		         		        @if($errors->has('price'))
...
<div class="form-group">
		    ...
		    <div class="col-lg-9 col-md-12 col-sm-12 {{ $errors->has('duration')?'has-error':'' }}">
		    	<input  step="1" name="duration" value="{{ old('duration') }}"  class="form-control" id="duration" placeholder="Duration" type="number">
