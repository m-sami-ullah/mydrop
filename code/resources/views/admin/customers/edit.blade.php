...
<form class="form-horizontal"   method="post" action="{{route('customers.update',['customer'=>$customer->id])}}" enctype="multipart/form-data">
		...
		<div class="col-md-12">
	        <div class="panel">
			    ...
			    <div class="col-lg-8 col-md-6 col-sm-12 {{ $errors->has('firstname')?'has-error':'' }}">
			        <input   name="firstname" value="{{ old('firstname',$customer->firstname) }}"  class="form-control" id="firstname" placeholder="First Name" type="text">
		...
		<div class="col-lg-6 col-md-6 col-sm-12"> 
			<div class="form-group">
			    ...
			    <div class="col-lg-8 col-md-6 col-sm-12 {{ $errors->has('lastname')?'has-error':'' }}">
			        <input   name="lastname" value="{{ old('lastname',$customer->lastname) }}"  class="form-control" id="lastname" placeholder="Last Name" type="text">
		...
		<div class="col-lg-6 col-md-6 col-sm-12"> 
			<div class="form-group">
			    ...
			    <div class="col-lg-8 col-md-6 col-sm-12 {{ $errors->has('email')?'has-error':'' }}">
			        <input   name="email" value="{{ old('email',$customer->email) }}"  class="form-control" id="email" placeholder="Email" type="email">
			         		        @if($errors->has('email'))
		...
		<div class="col-lg-6 col-md-6 col-sm-12"> 
			<div class="form-group">
			    ...
			    <div class="col-lg-8 col-md-6 col-sm-12 {{ $errors->has('phone')?'has-error':'' }}">
			        <input   name="phone" value="{{ old('phone',$customer->phone) }}"  class="form-control" id="phone" placeholder="Phone Number" type="text">
			        		        @if($errors->has('phone'))
