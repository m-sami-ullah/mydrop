...
<div class="form-group">
		    ...
		    <div class="col-lg-9 col-md-12 col-sm-12 {{ $errors->has('deviceid')?'has-error':'' }}">
		        <input   name="deviceid" value="{{ old('deviceid') }}"  class="form-control" id="deviceid" placeholder="FCC ID" type="text">
		...
		<div class="form-group">
		    ...
		    <div class="col-lg-9 col-md-12 col-sm-12 {{ $errors->has('ip')?'has-error':'' }}">
		        <input   name="port" value="{{ old('port') }}"  class="form-control" id="port" placeholder="Device port" type="text">
		        		        @if($errors->has('port'))
		...
		<div class="form-group">
		    ...
		    <div class="col-lg-9 col-md-12 col-sm-12 {{ $errors->has('model')?'has-error':'' }}">
		        <input   name="model" value="{{ old('model') }}"  class="form-control" id="model" placeholder="Device Model" type="text">
		        		        @if($errors->has('model'))
		...
		{{-- <div class="form-group " >
		    ...
		    <div class="col-lg-9 col-md-12 col-sm-12 {{ $errors->has('install')?'has-error':'' }}">
		    	<div class="input-group date date_picker">
		        	<input   name="install" value="{{ old('install') }}"  class="form-control" id="install" type="text" data-date-format="dd-mm-yyyy">
		...
		{{-- <div class="form-group">
		    ...
		    <div class="col-lg-9 col-md-12 col-sm-12 {{ $errors->has('channels')?'has-error':'' }}">
		        <input   name="channels" value="{{ old('channels') }}"  class="form-control" id="channels" placeholder="Channenls" type="text">
		...
		{{-- <div class="form-group">
		    ...
		    <div class="col-lg-9 col-md-12 col-sm-12 {{ $errors->has('installed')?'has-error':'' }}">
		        <input   name="installed" value="{{ old('installed',1) }}"    class="" id="installed" placeholder="Installed" type="checkbox">
