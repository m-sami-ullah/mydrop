...
<form class="form-horizontal"   method="post" action="{{route('countries.store')}}" enctype="multipart/form-data"> 
...
<div class="col-lg-6 col-md-6 col-sm-12">
	        <div class="form-group">
			    ...
			    <div class="col-lg-8 col-md-6 col-sm-12 {{ $errors->has('iso')?'has-error':'' }}">
			        <input   name="iso" value="{{ old('iso') }}"  class="form-control" id="iso" placeholder="ISO" type="text">
			        			        @if($errors->has('iso'))
...
<div class="col-lg-6 col-md-6 col-sm-12">
	        <div class="form-group">
			    ...
			    <div class="col-lg-8 col-md-6 col-sm-12 {{ $errors->has('nicename')?'has-error':'' }}">
			        <input   name="nicename" value="{{ old('nicename') }}"  class="form-control" id="nicename" placeholder="Nick Name" type="text">
...
<div class="col-lg-6 col-md-6 col-sm-12">
	        <div class="form-group">
			    ...
			    <div class="col-lg-8 col-md-6 col-sm-12 {{ $errors->has('iso3')?'has-error':'' }}">
			        <input   name="iso3" value="{{ old('iso3') }}"  class="form-control" id="iso3" placeholder="ISO 3 Character Code" type="text">
			        			        @if($errors->has('iso3'))
...
<div class="col-lg-6 col-md-6 col-sm-12">
	        <div class="form-group">
			    ...
			    <div class="col-lg-8 col-md-6 col-sm-12 {{ $errors->has('numcode')?'has-error':'' }}">
			        <input   name="numcode" value="{{ old('numcode') }}"  class="form-control" id="numcode" placeholder="Number Code" type="number">
...
<div class="col-lg-6 col-md-6 col-sm-12">
	        <div class="form-group">
			    ...
			    <div class="col-lg-8 col-md-6 col-sm-12 {{ $errors->has('phonecode')?'has-error':'' }}">
			        <input   name="phonecode" value="{{ old('phonecode') }}"  class="form-control" id="phonecode" placeholder="Phone Code" type="number">
