...
<form class="form-horizontal"   method="post" action="{{route('groups.update',['group'=>$group->id])}}" enctype="multipart/form-data">
...
<div class="col-md-12">
        <div class="panel">
		    ...
		    <div class="col-lg-9 col-md-12 col-sm-12 {{ $errors->has('name')?'has-error':'' }}">
		        <input   name="name" value="{{ old('name',$group->name) }}"  class="form-control" id="name" placeholder="Name" type="text">
		        		        @if($errors->has('name'))
                                            ...
                                            ?>                              
                                                <div class="col-md-4 mb-1">
                                                    <div class="permission_box" ><?php echo $module->name;?> 
                                                        ...
                                                        {
                                                            $group_permission =  $group->group_permission->where('id',$permission->id)->first();
                                                            // dd();
                                                            $checked = ''; 
                                                            if ($group_permission) 
                                                            {
                                                        ...
                                                        <div class="checkbox">
                                                            ...
                                                            <input  type="checkbox" value="<?php echo $permission->id ?>"   name="permission_id[<?php echo $permission->id ?>]"  <?php  echo $checked;?>> <i></i>
