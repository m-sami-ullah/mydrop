...
<form class="form-horizontal"   method="post" action="{{route('faqs.update',['faq'=>$faq->id])}}" enctype="multipart/form-data">
        ...
        <div class="panel">
	        ...
	        <div class="form-group">
			    ...
			    <div class="col-lg-10 col-md-9 col-sm-12 {{ $errors->has('question')?'has-error':'' }}">
			        <input   name="question" value="{{ old('question',$faq->question) }}"  class="form-control" id="question" placeholder="Question" type="text">
...
<div class="col-lg-12 col-md-6 col-sm-12">
        <div class="form-group">
		    ...
		    <div class="col-lg-10 col-sm-9 {{ $errors->has('answer')?'has-error':'' }}">
		    	<textarea   name="answer"   class="form-control summernote" id="answer" >{{ old('answer',$faq->answer) }}</textarea>
