...
<form class="form-horizontal"   method="post" action="{{route('boxes.store')}}" enctype="multipart/form-data"> 
...
<div class="col-lg-6 col-md-6 col-sm-12">
	        <div class="form-group">
			    ...
			    <div class="col-lg-8 col-md-6 col-sm-12 {{ $errors->has('boxnumber')?'has-error':'' }}">
			        <input   name="boxnumber" value="{{ old('boxnumber') }}"  class="form-control" id="boxnumber" placeholder="Box Number" type="text">
...
{{-- <div class="col-lg-6 col-md-6 col-sm-12">
	        <div class="form-group">
			    ...
			    <div class="col-lg-8 col-md-6 col-sm-12 {{ $errors->has('qrcode')?'has-error':'' }}">
			        <input   name="qrcode" value="{{ old('qrcode') }}"  class="form-control" id="qrcode" placeholder="QR Code" type="text">
